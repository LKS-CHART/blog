...
This year, we didn't just learn new things, our team members also had opportunities to exchange ideas, and share insights and experiences through talks and conferences. Our team presented about the Hemodialysis project at the [Renal Insight](https://www.constellationkidney.com/electronic-health-records/renal-insight/) User Group Meeting, shared lessons from implementing AI in healthcare from the CHARTwatch project and beyond, and discussed [estimating ROI for analytics and data projects](https://www.addevent.com/event/Qs19385054).
