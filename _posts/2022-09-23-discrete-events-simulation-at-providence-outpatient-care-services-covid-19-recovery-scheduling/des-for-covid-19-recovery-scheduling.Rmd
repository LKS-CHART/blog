...
## Methodologies
The simulation model is constructed using Python. [SimPy](https://simpy.readthedocs.io/en/latest/) is used as the essential library to construct the simulation model, along with Pandas and NumPy to help with the data science portion of the model. The python model mainly consists of three parts:
