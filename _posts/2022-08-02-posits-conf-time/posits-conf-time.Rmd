...
<input type="checkbox" unchecked> **Watch old talks**. These can all be found [here](). We recommend: [debugging](), [RStudio announcing they are PBC](), and [end-to-end data science](https://www.rstudio.com/resources/rstudioconf-2020/deploying-end-to-end-data-science-with-shiny-plumber-and-pins/).</input>


<input type="checkbox" unchecked>  **Make a list of places you want to visit.** We prepared our [sight-seeing and food map](). </input>
...
[INSERT HADLEY TWEET]</blockquote></div>
