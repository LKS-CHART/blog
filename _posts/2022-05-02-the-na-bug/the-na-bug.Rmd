...
The fix was quite straightforward. We updated the parameters of one of our function calls to specify that `''` (empty string) should be used to represent `NA`. From the [documentation of the RODBC package](https://cran.r-project.org/web/packages/RODBC/RODBC.pdf):
