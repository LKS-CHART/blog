...
Thanks to Ben Darwin, Chloe Pou-Prom, Meggie Debnath, and Derek Beaton for providing useful feedback on drafts of this post.

```{r, echo=FALSE, asis = TRUE, include=FALSE}
m_user <- "cfhammill"
m_id <- ""
